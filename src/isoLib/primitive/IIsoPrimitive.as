package isoLib.primitive
{
	...
	public interface IIsoPrimitive extends IIsoRenderer, IStyleClient
	{
		...
		function set isoZ (value:Number):void;
		...
		function get isoHeight ():Number;
		function set isoHeight (value:Number):void;
